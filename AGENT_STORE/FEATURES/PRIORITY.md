...
5. **FEATURE-20251223-oled-geometry** - Lock the logical window to 16x4 (Width=16, Height=4) and clamp coordinates so LCDproc layouts behave the same on LCD and OLED.
